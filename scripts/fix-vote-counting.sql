-- Fix the vote counting function to properly convert pesewas to votes
-- 100 pesewas = 1 vote
...
-- Success message
SELECT 'Vote counting function fixed successfully! Existing vote counts have been corrected.' as status;
