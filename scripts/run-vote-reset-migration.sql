-- =====================================================
-- VOTE RESET SYSTEM - DATABASE MIGRATION
-- =====================================================
-- Run this script in your Supabase SQL editor to set up
-- the vote reset system
...
-- 7. Create function to get current period for a campaign
...
-- 8. Create function to calculate period statistics
...
-- 10. Drop trigger if it exists, then create it
...
-- Success message
SELECT 'Vote reset system migration completed successfully! 🎉' as message;
