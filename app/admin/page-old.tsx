            ...
            <CardContent>
              <div className="h-96 w-full relative">
                {stats?.campaignPerformance && stats.campaignPerformance.length > 0 ? (
                  <Highcharts3DPie
                    data={stats.campaignPerformance.map((campaign: any, index: number) => ({
                      name: campaign.name,
                      ...
                      percentage: (campaign.revenue / stats.campaignPerformance.reduce((sum: number, c: any) => sum + c.revenue, 0)) * 100
                    }))}
                    title="Campaign Performance"
                    subtitle="Revenue distribution by campaign"
                    height={400}
                    width={600}
                    alpha={45}
                    beta={0}
